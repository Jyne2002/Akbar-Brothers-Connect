...
export const COMPANIES = [
  {
    ...
    publicCardHeadline: 'A Brand Beyond Tea',
    showcaseImage: '/quick-tea-company-photo.webp',
    showcaseImageAlt: 'Akbar Brothers product range',
    certificationsImage: '/akbar-certifications.webp',
    certificationsImageAlt: 'Akbar Brothers certifications',
  ...
  },
  {
    ...
    certificationsImage: '/akbar-certifications.webp',
    certificationsImageAlt: 'Certifications and quality standards',
    footerLogo: '/akbar-brand-logo.png',
    footerLogoAlt: 'Akbar Brothers brand logo',
    actionLinks: AKBAR_ACTION_LINKS,
